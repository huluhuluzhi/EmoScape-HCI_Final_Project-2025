...
HF_API_TOKEN = "hf_xxxxxxxx" # 若想使用，请替换成自己HuggingFace的真实 Token
...
with st.sidebar:
    ...
    enable_audio = st.checkbox("启用白噪音疗愈 (78%用户偏好)", value=True)
    enable_voice = st.checkbox("启用语音输入模式 (65%用户偏好)", value=True)
